...
class TableComponent extends Component {
  ...
  columns = [
    ...
    {
      dataField: METRICS.INFECTION_PER_CAPITA_ACCUMULATED,
      textPlaceholder: `table:column_${METRICS.INFECTION_PER_CAPITA_ACCUMULATED}`,
    ...
    {
      dataField: METRICS.MORTALITY_PER_CAPITA_ACCUMULATED,
      textPlaceholder: `table:column_${METRICS.MORTALITY_PER_CAPITA_ACCUMULATED}`,
      unitPlaceholder: 'table:unit_per_capita_accumulated',
      sort: true,
      formatter: this.perCapitaCellFormatter,
    },
